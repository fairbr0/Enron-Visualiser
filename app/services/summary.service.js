    ...
    return {
        ...
        execute: function() {
            SummaryService = (function () {
                ...
                SummaryService.prototype.getTopEmployees = function (metric) {
                    return this.http.get("http://" + this.url + "/employees?number=10&ordering=" + metric).map(function (response) { return response.json(); });
                };
